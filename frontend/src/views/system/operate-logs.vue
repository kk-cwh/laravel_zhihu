<template>
    <div>
        <Form label-position="right" :label-width="70" inline>
           <FormItem label="消息类型:" class="">
                <Input clearable type="text" v-model="query.msgname" placeholder="填写消息类型"></Input>
            </FormItem>
            ...
            <FormItem label="操作对象:" class="">
                <Input clearable type="text" v-model="query.LogRequest" placeholder=""></Input>
            </FormItem>
